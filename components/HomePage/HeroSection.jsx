...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-white overflow-hidden">
      ...
      <div className="relative w-full overflow-hidden" style={{ minHeight: "320px", background: "linear-gradient(135deg, #92400e 0%, #ea580c 33%, #c2410c 66%, #7c2d12 100%)" }}>
        ...
        {/* Content */}
        <div className="relative z-10 h-full flex items-center justify-center px-6 text-center" style={{ minHeight: "320px" }}>
        ...
        >
          ...
          <motion.path
            ...
            fill="url(#waveGrad1)"
            animate={{ d: ["M 0,80 Q 300,40 600,80 T 1200,80 L 1200,200 L 0,200 Z", "M 0,100 Q 300,60 600,100 T 1200,100 L 1200,200 L 0,200 Z", "M 0,80 Q 300,40 600,80 T 1200,80 L 1200,200 L 0,200 Z"] }}
          ...
          <motion.path
            ...
            fill="url(#waveGrad2)"
            animate={{ d: ["M 0,100 Q 300,70 600,100 T 1200,100 L 1200,200 L 0,200 Z", "M 0,110 Q 300,50 600,110 T 1200,110 L 1200,200 L 0,200 Z", "M 0,100 Q 300,70 600,100 T 1200,100 L 1200,200 L 0,200 Z"] }}
          ...
          <motion.path
            ...
            fill="url(#waveGrad3)"
            animate={{ d: ["M 0,120 Q 300,90 600,120 T 1200,120 L 1200,200 L 0,200 Z", "M 0,100 Q 300,80 600,100 T 1200,100 L 1200,200 L 0,200 Z", "M 0,120 Q 300,90 600,120 T 1200,120 L 1200,200 L 0,200 Z"] }}
