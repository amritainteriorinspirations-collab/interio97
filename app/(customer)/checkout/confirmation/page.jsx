...
function ConfirmationContent() {
  ...
  const isPrepaidPending =
    status === "pending" && order?.paymentMethod === "PREPAID";
            ...
            {[
              {
                ...
                sub: "You'll receive a confirmation email shortly",
              },
              {
                icon: Package,
                color: "text-blue-500",
                label: "Preparing your order",
                sub: "Our team is getting your items ready",
              },
              {
                icon: Truck,
                color: "text-violet-500",
                label: "Out for delivery",
                sub: "Expected in 3–5 business days",
              },
